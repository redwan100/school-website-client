...
function StudentCard({ student }) {
  ...
  return (
    <div className="bg-gradient-to-r from-stone-100 to-stone-300 rounded-lg overflow-hidden border border-stone-300 max-w-[20rem] sm:max-w-full mx-auto w-full">
      <div className="text-zinc-700 p-3 flex flex-col">
        ...
        <div className="mt-2 flex flex-col capitalize text-stone-600 font-medium">
          ...
          <button className="flex items-center justify-center gap-1 bg-slate-500 text-zinc-50 py-1 px-3 rounded-md capitalize text-sm hover:bg-slate-600  w-full  mt-8">
            details
          </button>
        </div>
      </div>
